---
title: Live Observation Logging — forward-validation instrumentation ONLY
source_url: repo://apps/gex/research/uw/live_logging/README.md
...
- unusual-whales
- flow
summary: '- FULL_COMBINED is REJECTED despite +7.8% return — it failed holdout stability (odd +17% / even −11.6%, 2/9 checks). - flags_eq_0 (zero red flags) is `research_more` only: +2.8%, PF 1.10, positive in all four holdout splits, but n=162 and it fails the median-return and outlier-dependency checks. It…'
url_sha1: ef5e1d10b105772aa814a3f7de1997be81399e96
simhash: '4621849658955002768'
status: vault
ingested_by: seed
---
